...
<body>
    ...
    <table>
        <h2 style="color:black;"><?php echo htmlspecialchars($_SESSION["login_username"]); ?></b>,Favourite Songs</h2>
        ...
        <table>
            ...
            $count = 0;
            $sqlstatement = "SELECT song_image, song_title, song_rating, song_duration, song_url, song_xid, favourite_xid FROM favourites_song
                             INNER JOIN songs ON songs.song_xid = favourites_song.song_id where user_id = $user_id;";
            ...
            ?>
                <tr>
                    ...
                    <td> <a href="favouriteform.php?delete=<?php echo $favid; ?>">
