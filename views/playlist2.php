...
<body>
    ...
    ?>
        <img class="img2" src="../images/<?php echo $playlist_img ?>" alt="bp">
    ...
    <table>
        <tbody>
            ...
            <?php
            $count = 0;
            $sqlstatement = "SELECT song_image, song_title, song_rating, song_duration, song_url, song_xid FROM playlist_items
            ...
            <tr>
                <td><?php echo $count; ?>
                    <img src="../images/play.png" id="play-btn" data-src="../audios/<?php echo $songurl; ?>"
                        name="<?php echo $title; ?>" onclick="play(this)">
                </td>
